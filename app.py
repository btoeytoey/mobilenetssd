...
lineaccesstoken = 'dA/NAfc6PmFtzMOBNwi3CqNZLRnoBqzfAkWoy0qRs75P3DnXL+agTuoqnZ+5wf1ExCx/LVPtpOW0jgaISIIOedPTgUe7W/XwFZmZ+N/8zASSYHVpHSW2DVxiwA301SIo/mBV4H/N4Ud37s0cX5Le6AdB04t89/1O/w1cDnyilFU='
...
def event_handle(event,json_line):
    ...
    if msgType == "text":
        ...
        if msg == "สวัสดี":
            replyObj = TextSendMessage(text="ว่าไงล่ะ")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ไปไหนดี":
            replyObj = TextSendMessage(text="เที่ยวที่พัทยา")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "ว่างไหม":
            replyObj = TextSendMessage(text="ไม่ว่าง")
            line_bot_api.reply_message(rtoken, replyObj)
        elif msg == "covid" :
            ...
            url = "https://dialogflow.cloud.google.com/v1/integrations/line/webhook/d2d30a55-a3bc-436b-96ef-ea2974f55129"
